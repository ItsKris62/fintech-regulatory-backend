...
export const vaultRouter = router({
   ...
   */
  getUploadLimits: orgMemberProcedure
    .use(withPlanContext)
    .query(async ({ ctx }) => {
      return vaultModule.getUploadLimits(ctx.orgMembership!.organizationId, ctx.plan);
    }),
   ...
   */
  getReplaceUrl: orgMemberProcedure
    .use(withPlanContext)
   ...
   */
  confirmReplace: orgMemberProcedure
    .input(
      z.object({
