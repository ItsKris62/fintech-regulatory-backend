...
export const DEFAULT_SYSTEM_CONFIG: SystemConfig = {
  ...
  aiPolicyModel: 'gemini:gemini-3.6-flash',
  aiQueryModel: 'gemini:gemini-3.6-flash',
  aiVerificationModel: 'gemini:gemini-3.6-flash',
  aiComplexAnalysisModel: 'gemini:gemini-3.6-flash',
  aiPolicyTemperature: 0.3,
  aiQueryTemperature: 0.5,
  // Available models (admin UI uses this to populate dropdowns)
  availableAIModels: ['gemini:gemini-3.6-flash', 'gemini:gemini-1.5-flash'],
