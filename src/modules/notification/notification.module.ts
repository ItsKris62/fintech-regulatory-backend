...
class NotificationModule {
  ...
  private inferCategory(type: string): NotificationCategoryName {
    ...
    const complianceTypes = new Set(['COMPLIANCE_ALERT', 'REQUIREMENT_DUE', 'CHECKLIST_GENERATED', 'CHECKLIST_COMPLETED', 'GAP_ANALYSIS_STARTED', 'GAP_ANALYSIS_COMPLETED', 'CORPUS_GAP_REPORT_INGESTED', 'POLICY_READY', 'POLICY_UPDATE', 'REPORT_READY', 'REVIEW_REQUESTED', 'EVENT_CREATED', 'EVENT_REMINDER']);
  ...
  private mapToPrismaType(type: string): string {
    const PRISMA_NATIVE = new Set([
      ...
      'EVENT_CREATED', 'EVENT_REMINDER', 'BLOG_AUTOMATION',
    ]);
